...
public class GreenHouseActivity extends Activity {
	...
	private void initAnimations(View view) {
		//Animation anim = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 1, Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 1,  Animation.RELATIVE_TO_SELF, 0);
		Animation anim = new ScaleAnimation(0,1,0,1,Animation.RELATIVE_TO_PARENT,0,Animation.RELATIVE_TO_PARENT,0);
