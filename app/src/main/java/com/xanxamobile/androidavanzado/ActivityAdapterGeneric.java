...
public class ActivityAdapterGeneric extends Activity {
	...
	public void onClickAddItem(View view){
		...
		int add = 1;
		int lastViewXTMP = view.getLeft();
		int lastViewYTMP = view.getTop();
		int lastViewRightTMP = view.getRight();
		int lastViewBottomTMP = view.getBottom();

		view.layout(lastViewXTMP, lastViewYTMP, lastViewRightTMP, lastViewBottomTMP);
